package cl.ingerencia.client.algolia.swagger;
...
import cl.ingerencia.client.algolia.swagger.auth.Authentication;
import cl.ingerencia.client.algolia.swagger.auth.HttpBasicAuth;
import cl.ingerencia.client.algolia.swagger.auth.ApiKeyAuth;
import cl.ingerencia.client.algolia.swagger.auth.OAuth;


@Component("cl.ingerencia.client.algolia.swagger.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://hn.algolia.com/api/v1";
